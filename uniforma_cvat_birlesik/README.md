# Birleştirilmiş uniformed_person veri seti
...
- Kaynak XML kopyaları yerel teslim ZIP’inde saklanmıştır. Bu GitHub klasörü birleştirilmiş veri setini içerir.
...
YOLO için görseller `yolo/images/`, etiketler `yolo/labels/` içindedir. Örnek görsel: `yolo/images/aa_poh_galeriler/aa_poh_galeriler_g00_000.jpg`; karşılık gelen etiket: `yolo/labels/aa_poh_galeriler/aa_poh_galeriler_g00_000.txt`.
...
Bu klasör 1.301 görsel ve 4.566 kutu içeren tamamlanmış CVAT birleştirmesidir. Tek sınıf `uniformed_person` olarak korunmuştur. `../uniforma/` klasöründeki hazır set ile sınıf eşleştirmesi veya birleştirme yapılmamıştır.
